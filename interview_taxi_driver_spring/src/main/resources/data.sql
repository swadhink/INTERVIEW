...
insert into car(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, manufacturer, DELETED)
values(1, true, now(),  'BMW B58', 'A01', 5.0, 4, 1, false);

insert into car(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, manufacturer, DELETED)
values(2, true, now(),  'BMW B38', 'B01', 4.0, 6, 1, false);

insert into car(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, manufacturer, DELETED)
values(3, false, now(),  'BMW N57', 'C01', 4.0, 6, 1, false);
